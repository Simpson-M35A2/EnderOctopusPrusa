...
#define STRING_CONFIG_H_AUTHOR "(Simpson, Ender-Octopus 5+)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-Octopus"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  14.51//13.48
    #define DEFAULT_Ki   1.32//1.28
    #define DEFAULT_Kd  39.76//35.58
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 115.62//10.00
  #define DEFAULT_bedKi 22.23//.023
  #define DEFAULT_bedKd 400.80//305.4
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 140 }  // { 320, 320, 1600, 200 }// From Creality { 80, 80, 800, 93.02 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1500, 1500, 8, 5000 } //{ 3000, 3000, 100, 10000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 24.5, 0, -0.58 }
...
#define XY_PROBE_FEEDRATE (133*60)//(133*60)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (7*60)//(4*60)

// Feedrate (mm/min) for the "accurate" probe of each point
#define Z_PROBE_FEEDRATE_SLOW (3*60)  // (Z_PROBE_FEEDRATE_FAST / 2)
...
#define Z_CLEARANCE_MULTI_PROBE     1.7 // Z Clearance between multiple probes
...
#define Y_BED_SIZE 355  //367

// Travel limits (mm) after homing, corresponding to endstop positions.
#define X_MIN_POS 0
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS 404.5  //382    //X_BED_SIZE //change to number to show x goes past the bed.
#define Y_MAX_POS 355  //368.5  //Y_BED_SIZE
#define Z_MAX_POS 420    //+ Z_MIN_POS
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
...
#define HOMING_FEEDRATE_MM_M { (90*60), (90*60), (15*60) } //{ (50*60), (50*60), (4*60) }
